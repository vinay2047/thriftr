...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-gray-50">
      {/* Hero Section */}
      <section className="bg-primary text-white h-screen w-full flex flex-col justify-center items-center text-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-4">Welcome to Thriftr</h1>
        <p className="text-lg md:text-2xl mb-8">
          Buy and sell pre-loved treasures effortlessly
        </p>
        <Button
          size="lg"
          ...
          {[
            {
              name: "Aarav",
              review:
                "Thriftr made selling my old clothes so easy. I love how quick and simple the process was!",
            },
            {
              name: "Meera",
              review:
                "I found a brand-new phone for half the price. Couldn’t believe how smooth the experience was.",
            },
            {
              name: "Rohit",
              review:
                "The secure payments and on-time delivery gave me peace of mind. Definitely recommending this to friends.",
            },
          ].map((user, i) => (
            <Card key={i} className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6 text-center">
      ...
      {/* Footer */}
      <footer className="bg-primary text-white mt-auto w-full py-12 px-6 lg:px-24">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          {/* About */}
          <div>
            <h3 className="font-bold text-lg mb-4">
              <Link to="/about">About Us</Link></h3>
            <p className="text-sm text-white/80">
              Thriftr is your go-to platform for buying and selling pre-loved items. Sustainable,
              simple, and stylish.
            </p>
          </div>
        ...
        <div className="mt-12 border-t border-primary/50 pt-6 text-center text-sm text-white/80">
